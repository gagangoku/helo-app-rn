...
import {TaskListCreator} from "../platform/TaskListCreator";
import {SpreadsheetCreator} from "../platform/SpreadsheetCreator";
...
export class NewTaskListScreen extends React.Component {
    static URL = HOME_PAGE_URLS.newTaskList;
    constructor(props) {
        super(props);
    }
    render() {
        ...
        const me = JSON.parse(getUrlParam('me'));
        const collection = getUrlParam('collection');
        return <TaskListCreator groupId={groupId} groupName={groupName} collection={collection} me={me} />;
    }
}

export class NewSpreadsheetScreen extends React.Component {
    static URL = HOME_PAGE_URLS.newSpreadsheet;
    constructor(props) {
        super(props);
    }
    render() {
        ...
        const me = JSON.parse(getUrlParam('me'));
        const collection = getUrlParam('collection');
        return <SpreadsheetCreator groupId={groupId} groupName={groupName} collection={collection} me={me} />;
    }
}
