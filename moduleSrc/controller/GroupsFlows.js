...
export class StepInventoryBot extends React.Component {
    static URL = GROUP_URLS.inventoryBot;
    constructor(props) {
        super(props);
    }
    render() {
        cnsole.log('rendering StepInventoryBot');
        return (<SimpleBotClient location={this.props.location} history={this.props.history} botName="inventory" />);
    }
}
