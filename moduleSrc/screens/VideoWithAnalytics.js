...
export default class VideoWithAnalytics extends React.PureComponent {
    ...
    render () {
        const videoUrl = this.detailsObj.videoUrl || 'https://videos-lb.heloprotocol.in/small.mp4-383631-727548-1580289043272.mp4';
        return (
            <View style={{ height: WINDOW_INNER_HEIGHT, width: WINDOW_INNER_WIDTH, backgroundColor: '#000000', paddingTop: 10,
                           display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                <video style={{ objectFit: 'contain', maxHeight: '95%', maxWidth: '95%', outline: 'none' }} controls={true} autoPlay={true} onTimeUpdate={this.onTimeUpdate}>
