...
export class InputTextBarWithAttachIcons extends React.Component {
    ...
    onAttachCompleteFn = (obj) => {
        cnsole.info('onAttachCompleteFn: ', obj);
        if (obj) {
    ...
    render() {
        ...
        const { me, groupInfo, keyboardInputDisabled, enableSpeechRecognition, micListening } = this.props;
            ...
            <View style={{ height: 40, width: 40 }} ref={this.attachIconParentRef}>
                ...
                >
                    <View style={{ display: 'flex', flexDirection: 'column', fontFamily: CHAT_FONT_FAMILY, padding: 10 }}>
                        <AttachPopup me={me} groupInfo={groupInfo}
                                     onChooseTrainingVideo={this.onChooseTrainingVideo}
                                     onCompleteFn={this.onAttachCompleteFn} closeFn={this.closePopoverFn} />
                    </View>
                </Popover>
        ...
        const inputBox = (
            <View style={customStyle.inputBox}>
                <View style={inputStyle}>
                    <TextareaElemHackForPaste style={inputStyle} placeholder="  Type here ..." type="text" {...inputClassAttr}
        ...
        const recordingTime = (
            <View style={customStyle.inputBox}>
                <Text style={inputStyle}>{'  Recording ' + numDotsStr}</Text>
            </View>
        );
